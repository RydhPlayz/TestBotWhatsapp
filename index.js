...
//
const BotName = 'RYDH BOT'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/iam.rydh/'; // Nama Instagramlu cok
const whatsapplu = '083870429600'; // Nomor whatsapplu cok
const kapanbotaktif = '3 jam'; // Kapan bot lu aktif
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Scan kode qr mu menggunakan screenshot`);
});
